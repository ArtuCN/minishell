...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/07 12:09:40 by aconti            #+#    #+#             */
/*   Updated: 2024/07/10 09:56:34 by aconti           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ctrl_c(int sig)
{
	...
	(void)sig;
	if (g_sig_type == 2 || g_sig_type == 0
		|| g_sig_type == SIG_C || g_sig_type == 42)
	{
		write(1, "\n", 1);
		prompt = set_prompt_c();
		printf("%s\n", prompt);
